       ...
       child: Column(
         children: [
           ...
           itemQuestaoHumanas(
             ...
             '''1. (Enem PPL 2009)  Na Bíblia, a criação do mundo é descrita a partir das ordens de um único ser, que é Deus: “Disse Deus: Haja luz; e houve luz” (Gen., 1:3).
             Porém, em certos mitos ameríndios, inclusive brasileiros, a criação do mundo é poeticamente apresentada como resultado de um diálogo entre múltiplos espíritos. 
             As linhas a seguir servem como exemplo.
             Elas narram o surgimento de um desses espíritos criadores (demiurgos):
             “Tendo florido (em forma humana) / Da sabedoria contida em seu ser de céu / Em virtude de seu saber que se abre em flor, / Soube para si em si mesmo / a essência da essência da essência das belas palavras primeiras”.
             CESARINO, Pedro de N. Os Poetas. Folha de S. Paulo. 18 jan. 2009: p. 6-7 (adaptado).

             A Bíblia trata da criação em linguagem poética. Analogamente, são poéticas as linhas ameríndias acima citadas.
           ...
           itemQuestaoHumanas(
             ...
             '''2. (Enem PPL 2015)  Os nossos ancestrais dedicavam-se à caça, à pesca e à coleta de frutas e vegetais, garantindo sua subsistência, porque ainda não conheciam as práticas de agricultura e pecuária. Uma vez esgotados os alimentos, viam-se obrigados a transferir o acampamento para outro lugar.
           ...
           itemQuestaoHumanas(
             ...
             '''3. (Enem PPL 2019) Uma privatização do espaço maior do que aquela proporcionada pelo quarto evidencia-se cada vez mais nos séculos XVII e XVIII. Como as ruelles [espaço entre a cama e a parede], as alcovas são espaços além do leito, longe da porta que dá acesso à sala (ou à antecâmara, nas casas da elite).
             Thomas Jefferson, tecnólogo do estilo século XVIII, mandou construir uma parede em torno de sua cama a fim de fechar completamente o pequeno cômodo além do leito – cômodo no qual só ele podia entrar, descendo da cama do lado da ruelle.
           ...
           itemQuestaoHumanas(
             ...
             oferecendo aos diferentes atores históricos uma importância diferenciada, distinta, individual. Mas não se tratava mais de fazer, simplesmente, a história dos grandes nomes, em formato hagiográfico – quase uma vida de santo –, sem problemas, nem máculas. Mas de examinar os atores (ou o ator) célebres ou não, como testemunhas, como reflexos, como reveladores de uma época.”
